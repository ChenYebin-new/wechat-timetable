...
function reset(courses = []) {
  storage = new Map([[TIMETABLE_KEY, { schemaVersion: 4, term: clone(TERM), courses: clone(courses), periodSettings: clone(DEFAULT_PERIOD_SETTINGS) }]])
  timetableWrites = 0
